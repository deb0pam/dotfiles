...
static const char *bdown[]={"/bin/sh","-c","xrandr --output eDP-1 --brightness $(echo $(xrandr --verbose|grep -i brightness|awk '{print $2}') 0.05|awk '{print $1-$2}')",NULL};

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ 0,                            XK_F2,     spawn,          {.v=vdown}},
	{ 0,                            XK_F3,     spawn,          {.v=vup}},
	{ 0,                            XK_F5,     spawn,          {.v = bdown} },
	{ 0,                            XK_F6,     spawn,          {.v = bup } },
